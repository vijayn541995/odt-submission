...
- Show: live app at `http://127.0.0.1:4173/`
...
- Action: paste the Employee Finder feature story and show the uploaded mockup
- Pause: 2 seconds after pasting
- Say: `ODT starts by taking the work item, its acceptance criteria, and the attached mockup, then turns that input into a clearer, governed plan before any implementation is delegated.`

### Shot 4

- Show: target repo path, uploaded mockup, and reviewer note area
- Action: point to review controls
- Pause: 2 seconds
- Say: `A human reviewer can refine the request here, add review guidance, and use the mockup to keep visual intent aligned before execution starts.`
