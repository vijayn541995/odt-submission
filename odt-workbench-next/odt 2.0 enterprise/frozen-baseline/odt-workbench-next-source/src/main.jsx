  ...
  return (
    <div className="app-shell">
      ...
      <main className="main-shell">
        <TopHeader data={workbench} onRefresh={workbench.refresh} onSwitchAssignment={workbench.switchAssignment} />
...
function buildVerificationEvidenceRows({ evidence = {}, workflow = {}, latestReport = null } = {}) {
  ...
  const prReport = latestReport || currentPrReadinessReports(evidence)?.[0]?.reportJson || null;
